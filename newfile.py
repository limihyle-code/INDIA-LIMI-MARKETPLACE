...
def home():
    ...
    <script>
        ...
        const translations = {
            ...
            hi: { search_ph: "सामान खोजें...", urgent_badge: "इमरजेंसी", price_drop_badge: "दाम घटा", offer_btn: "ऑफर", chat_btn: "बात करें", bargain_title: "🏷️ अपना दाम लगाएं", listed_price: "तय दाम", your_offer_price: "आपकी कीमत (₹)", send_offer: "ऑफर भेजें", nav_home: "होम", nav_chats: "चैट", nav_ads: "विज्ञापन", nav_account: "खाता" },
...
def chats():
    return render_template_string(HTML_HEADER + """
    <div class="brand-header p-3 mb-3">
        <h4 class="fw-bold text-white m-0">Messages & Calls</h4>
    </div>
    <div class="container px-3">
        <div class="card border-0 rounded-4 p-3 shadow-sm mb-3">
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h6 class="fw-bold mb-0">Official Seller</h6>
                        <small class="text-muted">Tap to open conversation</small>
                    </div>
                </div>
                <a href="/chat_room?user_type=buyer&name=OfficialSeller" class="btn btn-dark btn-sm rounded-pill px-3">Chat</a>
            </div>
        </div>
    </div>
    <div class="bottom-nav">
...
def chat_room():
    ...
    target_name = request.args.get('name', 'Listing')
    ...
    <div class="brand-header p-3 d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center gap-2">
            ...
            <div>
                <h6 class="fw-bold m-0 text-white">{{ target_name }}</h6>
                <small class="text-success" style="font-size: 0.7rem;"><i class="bi bi-circle-fill"></i> Online</small>
            </div>
        </div>
    ...
    <div class="container p-3">
        ...
        <div class="alert alert-success border-0 rounded-4 shadow-sm text-center">
            <i class="bi bi-tags-fill me-1"></i> Sent Offer of <b>₹{{ offer_amount }}</b> to Seller!
        </div>
        {% endif %}

        <div class="card border-0 shadow-sm rounded-4 p-3 mb-3 bg-white" style="min-height: 300px; display: flex; flex-direction: column; justify-content: space-between;">
            <div id="chatMessages">
                <div class="text-center text-muted small my-2">Chat started for {{ target_name }}</div>
                <div class="bg-light p-2 rounded-3 w-75 mb-2 border">
                    <small class="fw-bold text-dark d-block">System</small>
                    <span class="small">Welcome! Keep transactions safe inside LIMI.</span>
                </div>
            </div>
    ...
    <script>
        function sendMessage(e) {
            ...
            msgDiv.innerHTML = `<small class="fw-bold d-block text-success">You</small><span class="small">${txt}</span>`;
            box.appendChild(msgDiv);
            input.value = '';
        }
    </script>
    </body></html>""", target_name=target_name, offer_amount=offer_amount)
